...
public class FemaleCardAdapter extends CardAdapter {
    public FemaleCardAdapter(List<CardBean> cardBeanList) {
        super(cardBeanList);
    }
    ...
    private void consumeOnce(CardBean cardBean) {
        ...
        new DatabaseHelper(mContext).consumeFemaleCardOnce(cardBean.getId());
    }
